...
@section('content')
    ...
    <div class="contendor-accesos-directos">
        <div class="accesos-directos pt-3" onclick="actualizaOpciones('div-modalidad', 'modalidad')" id="modalidad">
            <div>
        ...
        <div class="accesos-directos pt-3" onclick="actualizaOpciones('div-nivelEstudios', 'nivelEstudios')" id="nivelEstudios">
            <div>
        ...
        <div class="accesos-directos pt-3" onclick="actualizaOpciones('div-nivelProgramas', 'nivelProgramas')" id="nivelProgramas">
            <div>
    ...
    <div id="div-modalidad" style="display: none;" class="sub-buttons">
        <div class="contendor-accesos-directos">
    ...
    <div id="div-nivelEstudios" style="display: none;" class="sub-buttons">
        <div class="contendor-accesos-directos">
    ...
    <div id="div-nivelProgramas" style="display: none;" class="sub-buttons">
        <div class="contendor-accesos-directos">
